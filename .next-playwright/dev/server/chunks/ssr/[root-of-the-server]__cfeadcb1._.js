...
"[project]/lib/runtimeMode.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/authLocal.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function createSupabaseBrowserClient() {
    ...
    if (!browserClient) {
        browserClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$ssr$2f$dist$2f$module$2f$createBrowserClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createBrowserClient"])(url, anon);
    }
...
"[project]/lib/authSupabase.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function signUp(email, password) {
    try {
        const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$browser$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createSupabaseBrowserClient"])();
        ...
        const { data: me } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$browser$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSupabaseUser"])();
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$authLocal$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/authLocal.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$authSupabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/authSupabase.ts [app-ssr] (ecmascript)");
;
;
;
function impl() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$runtimeMode$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAuthMode"])() === "local" ? __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$authLocal$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ : __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$authSupabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__;
}
function getActiveUserId() {
...
"[project]/lib/supabase/userKvSync.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/scopedKey.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/sensitiveData.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function encryptValue(value) {
    ...
    const cipher = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$crypto$2d$js$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].AES.encrypt(value, SECRET).toString();
...
function decryptValue(value) {
    ...
    try {
        const bytes = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$crypto$2d$js$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].AES.decrypt(cipher, SECRET);
        const plain = bytes.toString(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$crypto$2d$js$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].enc.Utf8);
        return plain || value;
    } catch  {
        return value;
    }
...
"[project]/lib/userStore.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$browser$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/supabase/browser.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$userKvSync$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/supabase/userKvSync.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$runtimeMode$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/runtimeMode.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$scopedKey$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/scopedKey.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$sensitiveData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/sensitiveData.ts [app-ssr] (ecmascript)");
;
;
;
;
...
function isCloudKvKey(key) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$userKvSync$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["KV_KEYS"].includes(key);
}
...
function primeUserKvCache(userId, entries) {
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$runtimeMode$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAuthMode"])() !== "supabase") return;
...
function isActiveUserKvHydrated() {
    const userId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getActiveUserId"])();
    if (!userId) return true;
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$runtimeMode$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAuthMode"])() !== "supabase") return true;
    return isUserKvHydrated(userId);
}
function getActiveScopedKey(key) {
    const userId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getActiveUserId"])();
    if (!userId) return null;
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$scopedKey$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["scopedKey"])(key, userId);
}
function getUserItem(key, userId) {
    // Setup draft/resume are local-only (avoid Supabase KV writes + RLS issues).
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$runtimeMode$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAuthMode"])() === "supabase" && isSetupKey(key)) {
        try {
            const scoped = localStorage.getItem((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$scopedKey$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["scopedKey"])(key, userId));
    ...
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$runtimeMode$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAuthMode"])() === "supabase") {
        const bundled = readBundledValue(userId, key);
        if (bundled != null) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$sensitiveData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["revealSensitiveDataFromStorage"])(key, bundled);
        const raw = cloudCache.get(cacheId(userId, key)) ?? null;
        return raw == null ? null : (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$sensitiveData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["revealSensitiveDataFromStorage"])(key, raw);
    }
    const raw = localStorage.getItem((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$scopedKey$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["scopedKey"])(key, userId));
    return raw == null ? null : (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$sensitiveData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["revealSensitiveDataFromStorage"])(key, raw);
}
function setUserItem(key, value, userId) {
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$runtimeMode$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAuthMode"])() === "supabase" && isSetupKey(key)) {
        try {
            localStorage.setItem((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$scopedKey$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["scopedKey"])(key, userId), value);
    ...
    const valueForStorage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$sensitiveData$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["protectSensitiveDataForStorage"])(key, value);
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$runtimeMode$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAuthMode"])() === "supabase") {
    ...
    localStorage.setItem((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$scopedKey$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["scopedKey"])(key, userId), valueForStorage);
}
function removeUserItem(key, userId) {
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$runtimeMode$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAuthMode"])() === "supabase" && isSetupKey(key)) {
        try {
            localStorage.removeItem((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$scopedKey$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["scopedKey"])(key, userId));
...
function migrateGlobalKeyToUser(key, userId) {
    ...
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$runtimeMode$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAuthMode"])() === "supabase") return false;
    const global = localStorage.getItem(key);
    if (global == null) return false;
    const targetKey = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$scopedKey$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["scopedKey"])(key, userId);
...
function schedulePush(key, value) {
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$runtimeMode$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAuthMode"])() !== "supabase") return;
    const capturedUserId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getActiveUserId"])();
...
async function flushCloudKeyNow(key) {
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$runtimeMode$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAuthMode"])() !== "supabase") return;
    const activeUserId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getActiveUserId"])();
    if (!activeUserId) return;
    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$browser$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createSupabaseBrowserClient"])();
    const { data } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$browser$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSupabaseUser"])();
    ...
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$userKvSync$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["pushKvToSupabase"])(supabase, actualUserId, key, value);
}
}),
"[project]/context/BusinessContext.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function readBusinessFromStore() {
    if ("TURBOPACK compile-time truthy", 1) return emptyBusiness;
    //TURBOPACK unreachable
    ;
    const stored = undefined;
}
function BusinessProvider({ children }) {
    const [business, setBusinessState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(()=>readBusinessFromStore());
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        return ()=>window.removeEventListener("easybill:cloud-sync", onCloud);
    }, []);
    const value = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>({
            ...
            setBusiness (data) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$userStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setActiveOrGlobalItem"])("businessProfile", JSON.stringify(normalizedBusiness));
            }
        }), [
        business
    ]);
...
"[project]/lib/invoiceVisibilityShared.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/invoiceResetDate.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/context/SettingsContext.tsx [app-ssr] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$runtimeMode$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/runtimeMode.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/auth.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$invoiceVisibilityShared$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/invoiceVisibilityShared.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$invoiceResetDate$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/invoiceResetDate.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
const defaultSettings = {
    ...
    resetYearly: true,
    invoiceResetMonthDay: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$invoiceResetDate$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DEFAULT_RESET_MONTH_DAY"],
    currencySymbol: "₹",
    currencyPosition: "before",
    invoiceVisibility: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$invoiceVisibilityShared$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DEFAULT_INVOICE_VISIBILITY"]
};
...
function readSettingsFromStorage() {
    ...
    const savedAmount = undefined;
    const savedDecimals = undefined;
    const savedPrefix = undefined;
    const savedPadding = undefined;
    const savedStart = undefined;
    const savedReset = undefined;
    const savedResetMonthDay = undefined;
    const savedCurrency = undefined;
    const savedCurrencyPos = undefined;
    const savedInvoiceVisibility = undefined;
    let invoiceVisibility;
}
...
function SettingsProvider({ children }) {
    const [settings, setSettings] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(()=>readSettingsFromStorage());
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const supabaseNeedsHydration = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$runtimeMode$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAuthMode"])() === "supabase" && Boolean((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getActiveUserId"])());
    ...
    const value = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>({
            ...
            updateDateFormat (format) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$userStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setActiveOrGlobalItem"])("dateFormat", format);
            },
            updateAmountFormat (format) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$userStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setActiveOrGlobalItem"])("amountFormat", format);
            },
            updateShowDecimals (next) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$userStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setActiveOrGlobalItem"])("showDecimals", String(next));
            },
            updateInvoicePrefix (next) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$userStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setActiveOrGlobalItem"])("invoicePrefix", next);
            },
            updateInvoicePadding (next) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$userStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setActiveOrGlobalItem"])("invoicePadding", String(next));
            },
            updateInvoiceStartNumber (next) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$userStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setActiveOrGlobalItem"])("invoiceStartNumber", String(next));
            },
            updateResetYearly (next) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$userStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setActiveOrGlobalItem"])("resetYearly", String(next));
            },
            updateInvoiceResetMonthDay (next) {
                const normalized = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$invoiceResetDate$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["normalizeResetMonthDay"])(next);
                setSettings((prev)=>({
                        ...prev,
                        invoiceResetMonthDay: normalized
                    }));
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$userStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setActiveOrGlobalItem"])("invoiceResetMonthDay", normalized);
            },
            updateCurrencySymbol (next) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$userStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setActiveOrGlobalItem"])("currencySymbol", next);
            },
            updateCurrencyPosition (next) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$userStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setActiveOrGlobalItem"])("currencyPosition", next);
            },
            updateInvoiceVisibility (next) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$userStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setActiveOrGlobalItem"])("invoiceVisibility", JSON.stringify(next));
            }
        }), [
        settings
    ]);
...
__turbopack_context__.s([
    "DEFAULT_INVOICE_VISIBILITY",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$invoiceVisibilityShared$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DEFAULT_INVOICE_VISIBILITY"],
    "SettingsProvider",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$context$2f$SettingsContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["SettingsProvider"],
    "useSettings",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$context$2f$SettingsContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useSettings"]
]);
...
"[project]/components/providers/AppAlertProvider.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const AppAlertContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createContext"])(null);
...
function AppAlertProvider({ children }) {
    ...
    const showAlert = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((next)=>{
        setOpts({
            tone: "info",
            primaryLabel: "Got it",
            secondaryLabel: "",
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(AppAlertContext.Provider, {
        value: api,
        children: [
            children,
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DialogHeader"], {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("mx-auto flex h-[52px] w-[52px] shrink-0 items-center justify-center rounded-2xl sm:mx-0 sm:h-14 sm:w-14 sm:rounded-[1.125rem]", styles.iconWrap),
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DialogTitle"], {
                                                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("font-display pr-10 text-xl font-bold leading-snug tracking-tight text-slate-950 sm:pr-8 sm:text-2xl sm:leading-tight"),
                                                children: opts?.title || ""
                                            }, void 0, false, {
                                                fileName: "[project]/components/providers/AppAlertProvider.tsx",
                                                lineNumber: 151,
                                            ...
                                            opts?.actionHint ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                opts?.secondaryLabel ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    type: "button",
                                    onClick: ()=>{
                                        close();
                                        opts?.onSecondary?.();
...
function useAppAlert() {
    const ctx = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useContext"])(AppAlertContext);
    if (!ctx) {
...
"[project]/components/providers/SupabaseAuthSync.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SupabaseAuthSync() {
    const ran = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(false);
    const lastUserId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(null);
    const lastFocusSyncAt = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(0);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        async function sync(userId) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$userKvSync$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["pushLocalSeedIfSupabaseEmpty"])(supabase, userId);
            const rows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$userKvSync$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["pullSupabaseKvToCache"])(supabase, userId);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$userStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["clearUserKvCache"])(userId);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$userStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["primeUserKvCache"])(userId, rows);
        ...
        async function runInitial() {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setActiveUserId"])(user?.id || null);
            if (!user) {
        ...
        const { data: sub } = supabase.auth.onAuthStateChange((_evt, session)=>{
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setActiveUserId"])(nextId);
            if (prevId && prevId !== nextId) (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$userStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["clearUserKvCache"])(prevId);
            if (nextId) {
                void sync(nextId);
            } else {
                window.dispatchEvent(new Event("easybill:cloud-sync"));
...
function Skeleton({ className, ...props }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        "data-slot": "skeleton",
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("rounded-md bg-muted/70 eb-skeleton-pulse", className),
        ...props
    }, void 0, false, {
...
"[project]/components/providers/KvHydrationGate.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function KvHydrationGate({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const mode = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$runtimeMode$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAuthMode"])();
        if (mode !== "supabase") {
            setReady(true);
            return;
        }
        ...
        const checkReady = ()=>{
            ...
            if (userId) {
                if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$userStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isActiveUserKvHydrated"])()) setReady(true);
                return;
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cfeadcb1._.js.map