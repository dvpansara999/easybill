...
"minimal-dark": { accent:"#111827", soft:"#f5f5f5", line:"#d4d4d8", mode:"boxed", header:"split", summary:"rule", info:"stack", logo:false },
"minimal-white": { accent:"#374151", soft:"#ffffff", line:"#e5e7eb", mode:"open", header:"stack", summary:"clean", info:"detailsTop", logo:false },
"minimal-soft": { accent:"#4b5563", soft:"#f9fafb", line:"#e5e7eb", mode:"soft", header:"split", summary:"rule", info:"split", logo:true },
"minimal-pro": { accent:"#0f172a", soft:"#f8fafc", line:"#cbd5e1", mode:"boxed", header:"split", summary:"panel", info:"sidebar", logo:false },
"minimal-mono": { accent:"#18181b", soft:"#ffffff", line:"#d4d4d8", mode:"paper", header:"inline", summary:"rule", info:"stack", logo:false },
"minimal-calm": { accent:"#0f766e", soft:"#f0fdfa", line:"#ccfbf1", mode:"soft", header:"split", summary:"clean", info:"sidebar", logo:true },
"minimal-linen": { accent:"#92400e", soft:"#fffbeb", line:"#fde68a", mode:"boxed", header:"stack", summary:"panel", info:"detailsTop", logo:true },
"minimal-air": { accent:"#1d4ed8", soft:"#eff6ff", line:"#dbeafe", mode:"open", header:"inline", summary:"clean", info:"split", logo:true },
"minimal-paper": { accent:"#52525b", soft:"#fafaf9", line:"#e7e5e4", mode:"paper", header:"stack", summary:"rule", info:"sidebar", logo:false },
"minimal-stone": { accent:"#57534e", soft:"#fafaf9", line:"#d6d3d1", mode:"paper", header:"split", summary:"panel", info:"stack", logo:true },
...
"minimal-civic": { accent:"#2563eb", soft:"#ffffff", line:"#bfdbfe", mode:"open", header:"split", summary:"panel", info:"stack", logo:false },
...
"minimal-fold": { accent:"#7c3aed", soft:"#ffffff", line:"#ddd6fe", mode:"open", header:"inline", summary:"clean", info:"stack", logo:true },
...
"minimal-gridline": { accent:"#111827", soft:"#ffffff", line:"#d1d5db", mode:"boxed", header:"inline", summary:"rule", info:"detailsTop", logo:false },
"minimal-borderless": { accent:"#0f172a", soft:"#ffffff", line:"#f1f5f9", mode:"open", header:"stack", summary:"clean", info:"split", logo:true },
...
"minimal-arc": { accent:"#2563eb", soft:"#eff6ff", line:"#bfdbfe", mode:"soft", header:"split", summary:"panel", info:"detailsTop", logo:true },
"minimal-signal": { accent:"#0f766e", soft:"#f0fdfa", line:"#99f6e4", mode:"open", header:"inline", summary:"rule", info:"split", logo:false },
"minimal-zen": { accent:"#334155", soft:"#f8fafc", line:"#e2e8f0", mode:"plain", header:"stack", summary:"clean", info:"sidebar", logo:false },
"minimal-inkline": { accent:"#0f172a", soft:"#ffffff", line:"#94a3b8", mode:"boxed", header:"inline", summary:"rule", info:"detailsTop", logo:true },
"minimal-studio": { accent:"#7c2d12", soft:"#fff7ed", line:"#fdba74", mode:"boxed", header:"split", summary:"panel", info:"split", logo:true },
"minimal-lattice": { accent:"#4338ca", soft:"#eef2ff", line:"#c7d2fe", mode:"paper", header:"stack", summary:"rule", info:"detailsTop", logo:true },
"minimal-copper": { accent:"#b45309", soft:"#fffbeb", line:"#fde68a", mode:"soft", header:"inline", summary:"panel", info:"sidebar", logo:false },
