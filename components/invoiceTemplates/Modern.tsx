...
"modern-slate": { accent:"#334155", soft:"#cbd5e1", tint:"#f8fafc", mode:"side", table:"grid", summary:"boxed", info:"sidebar", logo:true },
...
"modern-glass": { accent:"#0ea5e9", soft:"#bae6fd", tint:"#f0f9ff", mode:"glass", table:"zebra", summary:"glass", info:"cards", logo:true },
"modern-neon": { accent:"#c026d3", soft:"#f5d0fe", tint:"#fdf4ff", mode:"stripe", table:"grid", summary:"card", info:"sidebar", logo:false },
"modern-stripe": { accent:"#ea580c", soft:"#fed7aa", tint:"#fff7ed", mode:"stripe", table:"lines", summary:"inline", info:"split", logo:true },
"modern-cobalt": { accent:"#1e3a8a", soft:"#bfdbfe", tint:"#eff6ff", mode:"side", table:"grid", summary:"card", info:"sidebar", logo:false },
...
"modern-orbit": { accent:"#0f766e", soft:"#99f6e4", tint:"#f0fdfa", mode:"gridHero", table:"zebra", summary:"glass", info:"split", logo:true },
"modern-crest": { accent:"#7c2d12", soft:"#fdba74", tint:"#fff7ed", mode:"frame", table:"grid", summary:"boxed", info:"cards", logo:true },
...
"modern-eclipse": { accent:"#0b1220", soft:"#d1d5db", tint:"#f8fafc", mode:"side", table:"lines", summary:"boxed", info:"stack", logo:false },
...
"modern-vertex": { accent:"#3b82f6", soft:"#bfdbfe", tint:"#eff6ff", mode:"banner", table:"lines", summary:"inline", info:"cards", logo:false },
"modern-capsule": { accent:"#db2777", soft:"#fbcfe8", tint:"#fdf2f8", mode:"stripe", table:"zebra", summary:"card", info:"stack", logo:false },
"modern-lens": { accent:"#2563eb", soft:"#bfdbfe", tint:"#eff6ff", mode:"folio", table:"airy", summary:"glass", info:"sidebar", logo:true },
"modern-flare": { accent:"#ea580c", soft:"#fdba74", tint:"#fff7ed", mode:"frame", table:"grid", summary:"boxed", info:"cards", logo:true },
"modern-pulse": { accent:"#14b8a6", soft:"#99f6e4", tint:"#f0fdfa", mode:"glass", table:"zebra", summary:"glass", info:"split", logo:false },
...
"modern-coast": { accent:"#0369a1", soft:"#bae6fd", tint:"#f0f9ff", mode:"banner", table:"airy", summary:"boxed", info:"split", logo:true },
"modern-onyx": { accent:"#111827", soft:"#cbd5e1", tint:"#f8fafc", mode:"side", table:"grid", summary:"boxed", info:"cards", logo:false },
