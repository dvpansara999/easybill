...
"classic-heritage": { accent:"#78350f", paper:"#fffbeb", border:"#b45309", header:"heritage", table:"ledger", serif:true, info:"split", logo:true },
...
"classic-stamp": { accent:"#991b1b", paper:"#fffdfc", border:"#b91c1c", header:"stamp", table:"ledger", serif:true, info:"detailsFirst", logo:true },
...
"classic-deed": { accent:"#1f2937", paper:"#fffdf8", border:"#78716c", header:"formal", table:"ledger", serif:true, info:"split", logo:false },
"classic-stationery": { accent:"#172554", paper:"#eff6ff", border:"#60a5fa", header:"double", table:"plain", serif:true, info:"stack", logo:false },
...
"classic-saffron": { accent:"#7c2d12", paper:"#fff7ed", border:"#c2410c", header:"tax", table:"tax", serif:false, info:"stack", logo:true },
"classic-carbon": { accent:"#111827", paper:"#ffffff", border:"#374151", header:"office", table:"heavy", serif:false, info:"split", logo:false },
"classic-archive": { accent:"#1e293b", paper:"#f8fafc", border:"#94a3b8", header:"registry", table:"ledger", serif:false, info:"split", logo:false },
"classic-marble": { accent:"#44403c", paper:"#fffdf5", border:"#a8a29e", header:"serif", table:"plain", serif:true, info:"stack", logo:false },
"classic-sealblue": { accent:"#1e40af", paper:"#eff6ff", border:"#93c5fd", header:"seal", table:"plain", serif:true, info:"split", logo:true },
"classic-press": { accent:"#111827", paper:"#ffffff", border:"#6b7280", header:"ledger", table:"ledger", serif:false, info:"stack", logo:false },
"classic-crown": { accent:"#4c1d95", paper:"#faf5ff", border:"#7c3aed", header:"stamp", table:"plain", serif:true, info:"detailsFirst", logo:true },
