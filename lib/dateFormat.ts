export type StoredDateParts = {
  year: number
  month: number
  day: number
}

export function parseStoredDate(dateString: string | null | undefined): StoredDateParts | null {
...
export function getStoredDateParts(dateString: string | null | undefined) {
  return parseStoredDate(dateString)
}

export function storedDatePartsToDate(parts: StoredDateParts) {
  return new Date(parts.year, parts.month - 1, parts.day)
}

export function mapStoredDateToLocalDate(date: Date | null | undefined) {
...
export function compareStoredDates(left: string | null | undefined, right: string | null | undefined) {
