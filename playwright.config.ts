  ...
  projects: [
    {
      ...
      testMatch: authMode === "supabase" ? /supabase-dev-workspace\.spec\.ts/ : undefined,
      testIgnore: authMode === "supabase" ? undefined : /(?:mobile-branding|supabase-dev-workspace)\.spec\.ts/,
    },
    {
      name: "mobile-webkit",
      use: {
      ...
      testMatch: authMode === "supabase" ? /supabase-dev-workspace\.spec\.ts/ : /mobile-branding\.spec\.ts/,
    },
  ],
})
