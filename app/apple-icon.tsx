    ...
    (
      ...
      >
        <svg width="180" height="180" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <linearGradient id="easybill-apple-gradient" x1="10" y1="6" x2="56" y2="58" gradientUnits="userSpaceOnUse">
              <stop stopColor="#3b4046" />
              <stop offset="1" stopColor="#2a2f35" />
            </linearGradient>
          </defs>
          <rect x="6" y="6" width="52" height="52" rx="16" fill="url(#easybill-apple-gradient)" />
