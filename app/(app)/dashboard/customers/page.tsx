    ...
    <div className="space-y-6 xl:space-y-8">
      <section className="flex flex-col gap-5 xl:flex-row xl:items-end xl:justify-between">
        <div>
          ...
          <h1 className="font-display mt-2 text-2xl leading-tight text-slate-950 sm:text-3xl xl:mt-3 xl:text-4xl">Your client list, organized by revenue.</h1>
      ...
      <section className="grid grid-cols-2 gap-3 md:grid-cols-2 xl:grid-cols-4 xl:gap-5">
        ...
        <div className="soft-card rounded-[22px] p-3.5 sm:rounded-[24px] sm:p-6">
          ...
          <p className="mt-1.5 text-base font-semibold text-slate-950 sm:mt-2 sm:text-3xl">₹ {totalRevenue.toLocaleString("en-IN")}</p>
        </div>
        ...
        <div className="soft-card rounded-[22px] p-3.5 sm:rounded-[24px] sm:p-6">
          ...
          <p className="mt-1.5 truncate text-base font-semibold text-slate-950 sm:mt-2 sm:text-2xl">{topRevenueCustomer?.name || "-"}</p>
        ...
        <div className="soft-card rounded-[22px] p-3.5 sm:rounded-[24px] sm:p-6">
          ...
          <p className="mt-1.5 text-base font-semibold text-slate-950 sm:mt-2 sm:text-3xl">₹ {averageRevenue.toLocaleString("en-IN")}</p>
        </div>
      </section>
              ...
              >
                <div className="flex items-start justify-between gap-4">
                  <div className="min-w-0">
                    ...
                    <p className="mt-1 truncate text-xs text-slate-600 sm:text-sm">{c.phone}</p>
                  </div>
                ...
                <div className="mt-3 grid grid-cols-2 gap-2.5 sm:mt-4 sm:gap-3">
                  <div className="rounded-[16px] bg-slate-50 p-2.5 sm:rounded-[18px] sm:p-3">
                    ...
                    <p className="mt-1 text-base font-semibold text-slate-950 sm:text-lg">{c.invoices}</p>
                  </div>
                  <div className="rounded-[16px] bg-slate-50 p-2.5 sm:rounded-[18px] sm:p-3">
