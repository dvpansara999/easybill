  ...
  return (
    <div className="min-w-0 space-y-5 xl:space-y-8">
      ...
      <section className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
        <div>
          <p className="app-kicker">Templates / Modern</p>
          <h1 className="app-page-title mt-2 text-2xl sm:text-3xl xl:mt-3 xl:text-4xl">Modern templates.</h1>
          <p className="app-page-copy mt-2 max-w-2xl text-xs sm:mt-3 sm:text-sm">
            Cleaner hierarchy and stronger contrast for a contemporary invoice.
          </p>
        </div>
