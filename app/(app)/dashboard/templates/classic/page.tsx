  ...
  return (
    <div className="min-w-0 space-y-5 xl:space-y-8">
      ...
      <section className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
        <div>
          <p className="app-kicker">Templates / Classic</p>
          <h1 className="app-page-title mt-2 text-2xl sm:text-3xl xl:mt-3 xl:text-4xl">Classic templates.</h1>
          <p className="app-page-copy mt-2 max-w-2xl text-xs sm:mt-3 sm:text-sm">
            Formal invoice layouts with familiar structure and balanced sections.
          </p>
        </div>
