...
<div>
<p className="text-xs uppercase tracking-[0.34em] text-emerald-700">Classic Collection</p>
<h1 className="font-display mt-3 text-[2.45rem] leading-[1.08] text-slate-950">Explore classic templates rooted in formal invoice tradition.</h1>
