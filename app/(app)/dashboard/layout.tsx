    ...
    <div className="app-shell relative flex min-h-screen flex-col overflow-hidden lg:flex-row">
      ...
      <div className="relative z-[2] flex min-h-screen w-full min-w-0 max-w-full flex-col overflow-x-hidden lg:flex-row">
        ...
        <main className="min-w-0 flex-1 overflow-x-hidden overflow-y-auto">
          <div className="min-w-0 px-2 py-2 sm:px-4 sm:py-4 lg:px-3 lg:py-3">
            <div className="glass-card mx-auto my-1.5 w-full min-w-0 max-w-[1240px] min-h-[calc(100vh-0.75rem)] rounded-[26px] px-3 py-3 sm:px-5 sm:py-5 lg:mx-3 lg:my-3 lg:min-h-[calc(100vh-1.5rem)] lg:rounded-[36px] lg:px-8 lg:py-8">
            <div className="mb-5 flex flex-wrap items-start justify-between gap-3 border-b border-white/45 pb-4 sm:mb-7 sm:items-center sm:pb-6">
              <div className="min-w-0 flex items-center gap-3">
                <EasyBillLogoMark size={36} className="drop-shadow-sm sm:h-auto sm:w-auto" />
                <div>
                  <p className="text-xs font-semibold tracking-[0.24em] text-slate-500">easyBILL</p>
                  <p className="mt-1 text-xs leading-5 text-slate-600 sm:text-sm">A calm workspace for invoices, customers, templates, and settings.</p>
                </div>
              </div>
              ...
              <button
                ...
                className="app-secondary-button inline-flex items-center justify-center rounded-full p-2.5 text-slate-700 transition focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[rgba(29,107,95,0.12)] lg:hidden"
      ...
      <Dialog open={menuOpen} onOpenChange={setMenuOpen}>
        <DialogContent className="w-[calc(100%-1.5rem)] max-w-sm max-h-[85vh] overflow-hidden rounded-[30px] border border-white/60 bg-[rgba(255,255,255,0.82)] p-4 shadow-[0_30px_90px_rgba(31,41,55,0.16)] backdrop-blur-2xl">
