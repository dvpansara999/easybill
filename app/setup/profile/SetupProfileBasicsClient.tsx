    ...
    <main className="relative min-h-screen overflow-hidden bg-[linear-gradient(to_bottom,_#fafaf9,_#f1f5f9)] px-4 py-8 lg:px-6">
      ...
      <div className="relative mx-auto w-full max-w-[1120px]">
        ...
        <header className="mt-10 grid gap-6 lg:grid-cols-[1.1fr_0.9fr] lg:items-end">
          <div>
            <h1 className="font-display text-5xl leading-[1.02] text-slate-950">
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
          <aside className="order-2 space-y-6 lg:order-1 lg:sticky lg:top-8 lg:self-start">
            ...
            <div className="rounded-[34px] border border-emerald-200 bg-emerald-50/80 p-7 shadow-sm backdrop-blur">
          ...
          <section className="order-1 overflow-hidden rounded-[34px] border border-slate-200 bg-white shadow-[0_30px_90px_rgba(15,23,42,0.08)] lg:order-2">
            ...
            <div className="flex flex-col gap-3 border-t border-slate-200 bg-slate-50/70 px-7 py-6 sm:flex-row sm:items-center sm:justify-between">
