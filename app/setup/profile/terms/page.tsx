        ...
        <div className="flex items-center justify-between gap-4">
          <div className="inline-flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm font-semibold text-slate-950">Step 4 - Terms and notes</p>
            </div>
          </div>

          <div className="flex items-center gap-3">
            <div className="hidden text-xs font-semibold text-slate-600 sm:block">
              4<span className="text-slate-400">/</span>6
            </div>
            <div className="h-2 w-48 overflow-hidden rounded-full bg-[rgba(83,93,105,0.14)]">
              <div className="h-full w-4/6 rounded-full bg-gradient-to-r from-[var(--accent-soft)] via-[var(--accent-strong)] to-[rgba(165,196,193,0.95)]" />
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 grid gap-5 lg:grid-cols-[290px_minmax(0,1fr)] lg:items-center lg:gap-7">
          <aside className="space-y-5 lg:flex lg:h-full lg:items-center">
            <div className="app-dark-card overflow-hidden rounded-[28px] p-4 sm:p-5">
              <p className="text-[11px] font-semibold uppercase tracking-[0.32em] text-white/48">Terms and notes</p>
                ...
                <div className="mt-3 rounded-[18px] border border-white/10 bg-black/10 p-3.5">
                  <div className="flex items-start gap-3">
                    <div className="flex h-9 w-9 items-center justify-center rounded-2xl bg-white/10">
                      <ScrollText className="h-4 w-4 text-white/78" />
                    </div>
                    <div className="min-w-0">
                      <p className="text-[11px] uppercase tracking-[0.28em] text-white/42">Invoice note</p>
                      <p className="mt-1 text-[13px] font-semibold leading-6 text-white/88">
                        {draft.terms || "Payment due within 7 days. Please include the invoice number in the transfer note."}
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <section className="overflow-hidden rounded-[30px] border border-[rgba(83,93,105,0.12)] bg-[rgba(255,252,247,0.97)] shadow-[0_24px_60px_rgba(73,45,21,0.08)]">
            <div className="border-b border-[rgba(83,93,105,0.1)] px-4 py-4 sm:px-7 sm:py-5">
              <p className="app-kicker text-[11px]">Terms and notes</p>
              <p className="mt-2 max-w-2xl text-[15px] leading-7 text-slate-700 sm:text-[1.05rem]">
                Add a short note clients should see on the invoice.
              </p>
            ...
            <div className="px-4 py-5 sm:px-7 sm:py-6">
              <textarea
                ...
                className="app-textarea min-h-[220px] w-full rounded-2xl px-4 py-3 text-sm text-slate-900 outline-none transition"
              />
            </div>
            ...
            <div className="app-sticky-bar flex flex-col-reverse gap-3 border-t border-[rgba(83,93,105,0.11)] px-4 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-7 sm:py-5">
              ...
              <p className="text-sm text-slate-600 sm:ml-auto sm:mr-4">Next: logo.</p>
